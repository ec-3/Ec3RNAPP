export const en = {
  ...
  welcomeScreen: {
    ...
    createAccMessage: 'Create a new account with ec3',
  ...
  importAccount: {
    ...
    importQrCodeMessage1: 'Please make sure that you have granted ec3 the access to your device’s camera',
  ...
  attachAccount: {
    ...
    connectKeystoneMessage1: 'Open “Software Wallet” section on your Keystone and choose ec3',
  ...
  placeholder: {
    password: 'Password',
    typeYourec3Password: 'Type your ec3 password',
    accountName: 'Account name',
  ...
  message: {
    ...
    disconnectModalMessage:
      'Once you disconnect, you will no longer see this connection on ec3 and on your DApp.',
  ...
  header: {
    ...
    connectWithec3: 'Connect with ec3',
    signatureRequired: 'Signature required',
    messageDetails: 'Message details',
    signatureRequest: 'Signature request',
    connectec3: 'Connect ec3',
  ...
  confirmation: {
    ...
    siteNotConnectedMessage:
      'ec3 is not connected to this site. Please find and press in the website the "Connect Wallet" button to connect',
  ...
  warningMessage: {
    ...
    phishingMessage:
      'This site is blocked because the ec3 app believes that this website could compromise the security of your accounts and your tokens.',
  ...
  errorMessage: {
    ...
    noNetwork: 'ec3 does not currently recognize a chain with genesis hash, please add the network first',
